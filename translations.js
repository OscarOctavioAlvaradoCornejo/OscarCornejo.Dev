/**
 * CV WEB TECH MODERNO — Diccionario de Traducciones (Español / Inglés)
 * Oscar Octavio Alvarado Cornejo
 */
...
const translations = {
  es: {
    ...
    hero_name_prefix: "OSCAR OCTAVIO",
    hero_name_suffix: "ALVARADO CORNEJO",
    hero_title: "Desarrollador Junior & Analista QA",
    hero_location: "León, Guanajuato, México",
    hero_english: "Inglés: Intermedio (B2)",
    hero_career: "Ing. en Desarrollo y Gestión de Software",
    hero_summary: "Desarrollador Junior con sólida experiencia en control de calidad (QA) y desarrollo frontend con <strong>React 19, TypeScript y .NET 8 / Blazor WebAssembly</strong>. Actualmente colaborando en plataformas ERP en producción (CRM + gestión de proyectos). Enfoque integral que combina análisis funcional, desarrollo ágil bajo <strong>Scrum</strong>, automatización con <strong>Agentes IA (Copilot)</strong> y pruebas para clientes de alta exigencia como <strong>HDI Seguros</strong>.",
    ...
    exp1_b4: "<strong>Colaboración con HDI Seguros (Proyecto Colectividades):</strong> Participó en la generación de más de <strong>1,500 casos de prueba</strong>, ejecutando más de 300 matrices de prueba e identificando/reportando al menos 30 defectos críticos.",
    exp1_b5: "<strong>DevOps & Agentes IA:</strong> Control de ciclo de vida con <span class=\"code-pill\">GitHub</span> y <span class=\"code-pill\">Azure DevOps</span>, integrando flujos con <strong>Agentes IA de Microsoft Copilot</strong> para acelerar el análisis y desarrollo.",
    ...
    edu3_year: "2019 – 2022",
    edu3_degree: "Bachillerato Tecnológico en Programación",
  ...
  en: {
    ...
    hero_name_prefix: "OSCAR OCTAVIO",
    hero_name_suffix: "ALVARADO CORNEJO",
    hero_title: "Junior Developer & QA Analyst",
    hero_location: "León, Guanajuato, Mexico",
    hero_english: "English: Intermediate (B2)",
    hero_career: "B.S. in Software Development & Management",
    hero_summary: "Junior Developer with solid experience in Quality Assurance (QA) and frontend development with <strong>React 19, TypeScript, and .NET 8 / Blazor WebAssembly</strong>. Currently contributing to production ERP platforms (CRM + project management). Comprehensive profile combining functional analysis, agile development under <strong>Scrum</strong>, workflow automation using <strong>AI Agents (Copilot)</strong>, and testing for high-demand enterprise clients like <strong>HDI Seguros</strong>.",
    ...
    exp1_b4: "<strong>Collaboration with HDI Seguros (Colectividades Project):</strong> Contributed to the generation of over <strong>1,500 test cases</strong>, executing 300+ test matrices and detecting/reporting at least 30 critical defects.",
    exp1_b5: "<strong>DevOps & AI Agents:</strong> Managed application lifecycle with <span class=\"code-pill\">GitHub</span> and <span class=\"code-pill\">Azure DevOps</span>, integrating <strong>Microsoft Copilot AI Agents</strong> to accelerate analysis and development.",
    ...
    edu3_year: "2019 – 2022",
    edu3_degree: "Technical High School Diploma in Programming",
    edu3_school: "CBTIS 225",
